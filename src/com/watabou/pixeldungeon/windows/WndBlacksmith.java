...
public class WndBlacksmith extends Window {
	...
	private static final String TXT_PROMPT = PixelDungeon.resources
			.getString(R.string.bs_complete);
	private static final String TXT_SELECT = PixelDungeon.resources
			.getString(R.string.bs_reforge_select);
	private static final String TXT_REFORGE = PixelDungeon.resources
			.getString(R.string.bs_reforge);
