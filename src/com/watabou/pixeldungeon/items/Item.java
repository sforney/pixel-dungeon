...
public class Item implements Bundlable {
	...
	protected static final int TIME_TO_THROW = 10;
	protected static final int TIME_TO_PICK_UP = 10;
	protected static final int TIME_TO_DROP = 5;
	...
	public void updateQuickslot() {
		...
		} else if (QuickSlot.primaryValue == this
				|| QuickSlot.secondaryValue == this) {
			QuickSlot.refresh();
		}
	}
