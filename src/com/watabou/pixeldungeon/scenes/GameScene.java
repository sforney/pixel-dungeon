...
public class GameScene extends PixelScene {
	...
	private static final String TXT_WELCOME = Game
			.getVar(R.string.GameScene_Welcome);
	private static final String TXT_WELCOME_BACK = Game
			.getVar(R.string.GameScene_WelcomeBack);
	private static final String TXT_NIGHT_MODE = Game
			.getVar(R.string.GameScene_NightMode);

	private static final String TXT_CHASM = Game
			.getVar(R.string.GameScene_Chasm);
	private static final String TXT_WATER = Game
			.getVar(R.string.GameScene_Water);
	private static final String TXT_GRASS = Game
			.getVar(R.string.GameScene_Grass);
	private static final String TXT_SECRETS = Game
			.getVar(R.string.GameScene_Secrets);
	...
	public static void add(Mob mob) {
		...
		LevelState.add(mob, LevelState.getNow());
		mob.occupyCell();
	...
	public static void add(Mob mob, float delay) {
		Dungeon.level.mobs.add(mob);
		LevelState.addDelayed(mob, delay);
		mob.occupyCell();
		scene.addMobSprite(mob);
	}
	...
	public static WndBag selectItem(WndBag.Listener listener, WndBag.Mode mode,
		...
		WndBag wnd = mode == Mode.SEED ? WndBag
				.seedPouch(listener, mode, title) : WndBag.lastBag(listener,
				mode, title);
		scene.add(wnd);
